...
class MainWindow(wx.Frame):
    ...
    def createGui(self):
        ...
        self.leftpane.Add(vp, pos=(2,5), span=(4,1))
       	...
       	self.tempdisp = wx.StaticText(self.panel,wx.ID_ANY, "",size=(300,1))
        self.graph = Graph(self, wx.ID_ANY)
	#self.kb = KeyboardSizer(self)
        self.vizlogsizer.Add(self.graph, pos=(1,0)) # wx.ID_ANY)
        #self.hiddensizer.Add(self.tempdisp)
        self.vizlogsizer.Add(self.tempdisp, pos=(0,0))
