...
class PronterWindow(MainWindow, pronsole.pronsole):
	...
	print _("The file with calibration settings copied to '/home/calibration'")
        os.system("sudo cp /etc/X11/xorg.conf.d/99-calibration.conf /home/calibration")		
    ...
    def cbuttons_reload(self):
        ...
        for i in xrange(len(self.custombuttons)):
            ...
            try:
                b = wx.Button(self.panel, -1, btndef.label, style = wx.BU_EXACTFIT, size = (35,40))
                ...
                if i == newbuttonbuttonindex:
                    self.newbuttonbutton = b = wx.Button(self.panel, -1, "+", size = (35, 40), style = wx.BU_EXACTFIT)
